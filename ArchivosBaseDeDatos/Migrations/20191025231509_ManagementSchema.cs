        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Archivo64 = table.Column<string>(nullable: false),
                    ArchivoNombre = table.Column<string>(maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Documento = table.Column<long>(nullable: false),
                    Departamento = table.Column<string>(maxLength: 256, nullable: false),
                    TiempoInicio = table.Column<DateTime>(nullable: false),
                    TiempoFin = table.Column<DateTime>(nullable: false),
                    Usuario = table.Column<string>(maxLength: 256, nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Documento_Registro_Documento",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentoRegistro_Documento",
